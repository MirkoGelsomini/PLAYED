...
const GameBadge = ({ name, description, to, icon, soon }) => {
  return (
    <div style={badgeStyle}>
      ...
      {icon ? (
        ...
        <div style={{...iconStyle, background: '#F7C873', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', fontSize: '2rem', fontWeight: 700}}>
          {name?.[0] || '?' }
        </div>
      )}
